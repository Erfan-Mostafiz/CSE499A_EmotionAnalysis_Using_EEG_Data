...
# load trained model
Val_R = joblib.load("model/LRR_val_model.pkl")
Aro_R = joblib.load("model/LRR_aro_model.pkl")
Dom_R = joblib.load("model/LRR_dom_model.pkl")
Lik_R = joblib.load("model/LRR_lik_model.pkl")
